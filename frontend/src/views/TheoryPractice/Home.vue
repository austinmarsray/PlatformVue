<template>
  <div>
    <van-popup v-model:show="showPickcarType" round position="bottom">
      <van-picker
        show-toolbar
        :columns="carcolumns"
    ...
    <van-popup v-model:show="showPicktestType" round position="bottom">
      <van-picker
        show-toolbar
        :columns="testcolumns"
...
<script>
import itemCon from "@/components/TheoryPractice/itemCon";
